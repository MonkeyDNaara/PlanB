  ...
  return (
    ...
    >
      ...
      <div className="relative min-h-[360px] overflow-hidden border-t border-evently-border bg-evently-bg-secondary p-7 sm:min-h-[430px] sm:p-10 lg:border-l lg:border-t-0">
        <div
          className="absolute inset-0 bg-[radial-gradient(circle_at_80%_18%,rgba(124,92,255,0.25),transparent_32%),radial-gradient(circle_at_20%_86%,rgba(34,211,238,0.2),transparent_34%)]"
          aria-hidden="true"
        />
        <div
          className="absolute left-[12%] top-[14%] h-36 w-36 rotate-12 rounded-[2.5rem] border border-evently-primary/20 bg-evently-surface/35 shadow-[0_30px_80px_rgba(111,60,255,0.18)] backdrop-blur-xl sm:h-44 sm:w-44"
          aria-hidden="true"
        />
        <div
          className="absolute right-[10%] top-[8%] font-evently-brand text-8xl text-evently-primary/15 sm:text-9xl"
          aria-hidden="true"
        >
          E
        </div>
        ...
        <div className="relative mt-28 rounded-[1.75rem] border border-evently-border bg-evently-surface/85 p-6 shadow-[0_25px_70px_rgba(15,8,40,0.14)] backdrop-blur-xl sm:mt-40 sm:p-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <span className="text-xs font-semibold text-evently-muted">
              {featuredDate}
            </span>
          </div>
